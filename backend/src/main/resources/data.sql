...
INSERT INTO TB_ADVOGADO (NOME, CPF, ENDERECO, COMPLEMENTO, BAIRRO, CIDADE, UF, CEP, TELEFONE, CATEGORIA_ID) VALUES ('MARCILENE', '00000000002', 'RUA DESEMBARGADOR CONTINENTINO, 120', 'CASA', 'CAICARA', 'BH', 'MG','30720170', '999999999', '1');
...
-- Inserindo USUARIOS
INSERT INTO TB_USUARIO (USUARIO, PASSWORD, ADVOGADO_ID) VALUES ('mack', '$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG', 1);
INSERT INTO TB_USUARIO (USUARIO, PASSWORD, ADVOGADO_ID) VALUES ('marcilene', '$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG', 2);
...
-- Inserindo TIMESHEET
INSERT INTO TB_TIMESHEET (DATA, TEMPO, DESCRICAO, ADVOGADO_ID, COBRANCA, CASO_ID) VALUES ('2021-09-10', '2:00', 'Lorenipsonlorenipsonloreipson', 1, 1, 1);
INSERT INTO TB_TIMESHEET (DATA, TEMPO, DESCRICAO, ADVOGADO_ID, COBRANCA, CASO_ID) VALUES ('2021-10-10', '1:00', 'Lorenipsonlorenipsonloreipson', 1, 1, 1);
INSERT INTO TB_TIMESHEET (DATA, TEMPO, DESCRICAO, ADVOGADO_ID, COBRANCA, CASO_ID) VALUES ('2021-11-12', '1:40', 'Lorenipsonlorenipsonloreipson', 2, 1, 2);
INSERT INTO TB_TIMESHEET (DATA, TEMPO, DESCRICAO, ADVOGADO_ID, COBRANCA, CASO_ID) VALUES ('2021-09-20', '0:30', 'Lorenipsonlorenipsonloreipson', 2, 0, 1);
INSERT INTO TB_TIMESHEET (DATA, TEMPO, DESCRICAO, ADVOGADO_ID, COBRANCA, CASO_ID) VALUES ('2021-10-21', '5:30', 'Lorenipsonlorenipsonloreipson', 3, 0, 3);
INSERT INTO TB_TIMESHEET (DATA, TEMPO, DESCRICAO, ADVOGADO_ID, COBRANCA, CASO_ID) VALUES ('2021-09-13', '2:10', 'Lorenipsonlorenipsonloreipson', 2, 1, 4);
INSERT INTO TB_TIMESHEET (DATA, TEMPO, DESCRICAO, ADVOGADO_ID, COBRANCA, CASO_ID) VALUES ('2021-11-09', '0:40', 'Lorenipsonlorenipsonloreipson', 2, 0, 2);
INSERT INTO TB_TIMESHEET (DATA, TEMPO, DESCRICAO, ADVOGADO_ID, COBRANCA, CASO_ID) VALUES ('2021-11-10', '1:00', 'Lorenipsonlorenipsonloreipson', 2, 0, 6);
INSERT INTO TB_TIMESHEET (DATA, TEMPO, DESCRICAO, ADVOGADO_ID, COBRANCA, CASO_ID) VALUES ('2021-11-15', '2:40', 'Lorenipsonlorenipsonloreipson', 2, 0, 6);
INSERT INTO TB_TIMESHEET (DATA, TEMPO, DESCRICAO, ADVOGADO_ID, COBRANCA, CASO_ID) VALUES ('2021-10-16', '3:10', 'Lorenipsonlorenipsonloreipson', 3, 0, 5);
INSERT INTO TB_TIMESHEET (DATA, TEMPO, DESCRICAO, ADVOGADO_ID, COBRANCA, CASO_ID) VALUES ('2021-09-18', '1:10', 'Lorenipsonlorenipsonloreipson', 4, 1, 4);
INSERT INTO TB_TIMESHEET (DATA, TEMPO, DESCRICAO, ADVOGADO_ID, COBRANCA, CASO_ID) VALUES ('2021-09-19', '0:40', 'Lorenipsonlorenipsonloreipson', 4, 1, 4);
INSERT INTO TB_TIMESHEET (DATA, TEMPO, DESCRICAO, ADVOGADO_ID, COBRANCA, CASO_ID) VALUES ('2021-09-20', '1:00', 'Lorenipsonlorenipsonloreipson', 4, 1, 4);
INSERT INTO TB_TIMESHEET (DATA, TEMPO, DESCRICAO, ADVOGADO_ID, COBRANCA, CASO_ID) VALUES ('2021-09-18', '1:10', 'Lorenipsonlorenipsonloreipson', 1, 1, 4);
INSERT INTO TB_TIMESHEET (DATA, TEMPO, DESCRICAO, ADVOGADO_ID, COBRANCA, CASO_ID) VALUES ('2021-09-18', '1:10', 'Lorenipsonlorenipsonloreipson', 4, 1, 1);
INSERT INTO TB_TIMESHEET (DATA, TEMPO, DESCRICAO, ADVOGADO_ID, COBRANCA, CASO_ID) VALUES ('2021-09-18', '1:10', 'Lorenipsonlorenipsonloreipson', 4, 1, 2);
INSERT INTO TB_TIMESHEET (DATA, TEMPO, DESCRICAO, ADVOGADO_ID, COBRANCA, CASO_ID) VALUES ('2021-09-18', '1:10', 'Lorenipsonlorenipsonloreipson', 4, 1, 3);
